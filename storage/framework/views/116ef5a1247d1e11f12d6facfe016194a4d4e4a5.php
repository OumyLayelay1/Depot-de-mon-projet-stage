...
<head>
    ...
    <link rel="stylesheet" href="fichier_js/bootstrap.min.js.map">
    <link rel="stylesheet" href="fichier_style/bootstrap.min.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.1.1/css/brands.min.css" integrity="sha512-OivR4OdSsE1onDm/i3J3Hpsm5GmOVvr9r49K3jJ0dnsxVzZgaOJ5MfxEAxCyGrzWozL9uJGKz6un3A7L+redIQ==" crossorigin="anonymous" referrerpolicy="no-referrer" />
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.1.2/css/all.min.css" integrity="sha512-1sCRPdkRXhBV2PBLUdRb4tMg1w2YPf37qatUFeS7zlBy7jJI8Lf4VHwWfZZfpXtYSLy85pkm9GaYVYMfw5BC1A==" crossorigin="anonymous" referrerpolicy="no-referrer" />
    <link rel="stylesheet" href="fichier_style/acceuil.css">
    <title>KaayTukki</title>
</head>
<body>
            ...
            <nav class="navbar navbar-expand-lg navbar-light container ">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <ul class="navbar-nav unemenu">
                        <li class="nav-item active"><a href="accueil.html" class="nav-link maliste">Accueil</a></li>
                        <li class="nav-item"><a href="destination.html" class="nav-link maliste">Destinations </a></li>
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        ...
                        <div class=" link"><a href="destination.html" class="btn ici "><b class="text-light">Par ici</b></a></div>
                    </div>
                </div>    
    ...
    <section class="container main-image">
        <div class="row p-5 m-3 main-contain">
           <div class="col-md-3 plan">
                <div class="img1"><a href="#" class="organise"><img src="images/Group.png" alt="" class="w-75 figma"></a></div>
                <a href="#" class="organise"><h1 class="text-dark title">Planifier</h1></a>
           ...
           <div class="col-md-3 plan">
                <div class="img1"><a href="#" class="organise"><img src="images/Frame2.png" alt="" class="w-75 figma1"></a></div>
                <a href="#" class="organise"><h1 class="text-dark mt-1 title">Organiser</h1></a>
            ...
            <div class="col-md-3 plan">
                <div class="img1"><a href="#" class="organise"><img src="images/frame.png" alt="" class="figma1"></a></div>
                <a href="#" class="organise"><h1 class="text-dark mt-3 title">Voyager</h1></a>
    ...
    <section class="container img-text">
                <div class="pt-4 dakar">
                    ...
                    <a href="senegal.html" class="btn voir">Voir plus</a>
                   </div>
                </div>
                <div class="ilegoree">
...
</html><?php /**PATH D:\laragon\www\projet-stage\resources\views/welcome.blade.php ENDPATH**/ ?>